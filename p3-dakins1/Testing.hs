...
testGetKElems q = printTests q "Testing getKElems"
        [ assertEqual (length $getKElems 3 str) 3 show
        , assertEqual (length $getKElems 0 str) 0 show
        , assertEqual  (length $ nub $ getKElems 10 str) 10 show
...
testEucDist q = printTests q "Testing eucDist"
        ...
        , assertEqual (eucDist (10,5,10) (5,10,10)) (eucDist (10,5,10) (5,10,10)) show
...
testManhatDist q = printTests q "Testing manhatDist"
        ...
        , assertEqual (manhatDist (10,10,10) (20,0,10)) 20.0 show
...
testChebyDist q = printTests q "Testing chebyDist"
        ...
        , assertEqual (chebyDist (20,20,10) (55,0,10)) 35.0 show
...
testMinimize q = printTests q "Testing minimize"
        ...
        , assertEqual (minimize (id) [5, 7, 10, -3, -10, 4, -20]) (-20) show
...
testAssignPoint q = printTests q "Testing assignPoint"
        ...
        , assertEqual (assignPoint eucDist [(0,0,3), (10,10,4), (2,2,1)] (4,4,-1)) (2,2,1) show
        ][]
...
testGetKElemsSamples q = printTests q "Testing getKElems samples evenly" 
        ...
        , assertEqual (getKElems 3 ['A'..'P']) "AHP" show
        , assertEqual (getKElems 4 ['A'..'P']) "AFKP" show
        , assertEqual (getKElems 5 ['A'..'P']) "ADHLP" show
        ][]
        where str = ['A'..'Z']
